...
const GAMES = [
  ...
  { id: 3, title: "Serpentina", cat: "Arcade", cover: "cover-snake" },
  { id: 4, title: "Invasores", cat: "Arcade", cover: "cover-invaders" },
  { id: 5, title: "Rocas", cat: "Arcade", cover: "cover-rocas" },
  { id: 6, title: "Ranaria", cat: "Arcade", cover: "cover-rana" },
];

// Hook para animaciones reveal (IntersectionObserver)
function useReveal() {
  useEffect(() => {
...
// Componente: Silhuetas flotantes decorativas
...
// Componente: Tarjeta mini de juego
interface Game {
  id: number;
  title: string;
  cat: string;
        ...
        <div className="mini-rail">
          {GAMES.slice(0, 6).map((g) => (
            <MiniCard
              key={g.id}
              game={g}
              onClick={() => handleNavigate(`/detalle`)}
            />
          ))}
        </div>
          ...
          <div className="pricing-faq">
            ...
            <div className="faq-item">
              ...
              <div className="faq-a">
                ...
                puntuación y aparecer en el ranking, regístrate en 10 segundos.
              </div>
            </div>
            <div className="faq-item">
