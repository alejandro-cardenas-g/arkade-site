...
import SnakeGame, { SnakeGameHandle, GameCallbacks } from "./SnakeGame";
...
export default function SnakePage() {
  ...
  // Fetch user session and game data
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        console.log("Snake game loaded:", gameData?.id);
        setSnakeGame(gameData);
  ...
  const saveScore = useCallback(
    async (playerName: string) => {
      console.log("saveScore called with:", {
        playerName,
        snakeGameId: snakeGame?.id,
        score,
      });

      if (!snakeGame) {
        console.error("Cannot save score: missing snakeGame");
        return;
      }
  ...
  }, [isGameOver, score, snakeGame, showNameModal, saveScore]);
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="border-b border-gray-700 py-4 px-6">
        ...
        <p className="text-gray-400">Juego clásico de serpiente que crece</p>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex flex-col items-center justify-center">
              {/* Game canvas */}
              <div className="mb-6">
                <SnakeGame ref={gameRef} callbacks={callbacks} />
              </div>
              ...
              <div className="mt-8 bg-gray-800 p-6 rounded max-w-md">
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  ...
                  <li>
                    <span className="font-semibold">P o Espacio</span> — Pausa
                  </li>
                  <li>
                    <span className="font-semibold">Esc</span> — Reanudar
                  </li>
                </ul>
              </div>
            </div>
          ...
          {snakeGame && (
            <>
              <div className="mb-12">
                ...
                <GamesTable games={[snakeGame]} isLoading={false} />
              </div>
