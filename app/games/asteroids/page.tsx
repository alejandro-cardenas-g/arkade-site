...
export default function AsteroidsPage() {
  ...
  const [asteroidGame, setAsteroidGame] = useState<Game | null>(null);
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        console.log("Asteroides game loaded:", gameData?.id);
        setAsteroidGame(gameData);
  ...
  const saveScore = useCallback(
    async (playerName: string) => {
      console.log("saveScore called with:", {
        playerName,
        asteroidGameId: asteroidGame?.id,
        score,
      });

      if (!asteroidGame) {
        console.error("Cannot save score: missing asteroidGame");
        return;
      }
  ...
  }, [isGameOver, score, asteroidGame, showNameModal, saveScore]);
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="border-b border-gray-700 py-4 px-6">
        <h1 className="text-2xl font-bold">Asteroides</h1>
        <p className="text-gray-400">
          Juego clásico de disparo contra asteroides
        </p>
      </div>
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="mt-8 bg-gray-800 p-6 rounded max-w-md">
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  ...
                  <li>
                    <span className="font-semibold">P o Botón Pausar</span> —
                    Pausa
                  </li>
                </ul>
              </div>
          ...
          {asteroidGame && (
            <>
              <div className="mb-12">
                ...
                <GamesTable games={[asteroidGame]} isLoading={false} />
              </div>
